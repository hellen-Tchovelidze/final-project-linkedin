...
import Header from '../../__organisms/Header/Header';
import Reclient from '../../__atoms/Reclient/Reclient';
...
const FriendsList = dynamic(() => import('../../__moleculos/FriendsList/FriendsList'), { ssr: false });
